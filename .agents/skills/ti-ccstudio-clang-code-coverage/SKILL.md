...
- **CCStudio IDE installation path** (`<ccspath>`): Read from `.Codex/ccs.settings.md`.
...
`.Codex/ccs.settings.md` for the installation directory, then apply the platform-specific
